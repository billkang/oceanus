...
export class AgentDetailComponent {
  ...
  readonly relatedSkills = this.agent
    ? this.skillService.getSkillsByIds(this.agent.relatedSkillIds)
    : [];
