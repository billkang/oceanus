...
| [ADR-015](ADR-015-project-workspace-isolation.md)     | 项目物理工作区与 Agent 运行隔离         | 2026-08-02 | 架构      |
| [ADR-016](ADR-016-soft-delete-archive-merge.md)       | 全链路软删与 PRD 归档合并               | 2026-08-02 | 数据层/AI |
