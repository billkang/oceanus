...
Integrate Langfuse as an observability layer for the Claude Agent SDK, providing trace visualization, token tracking, and error monitoring. This is a non-intrusive addition that does not affect existing SDK session store behavior.
