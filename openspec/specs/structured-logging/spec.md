...
Replace the NestJS default logger with Pino (via `nestjs-pino`) for structured JSON logging. Supports console + file dual output with environment-aware log levels and session-based log directory structure.
